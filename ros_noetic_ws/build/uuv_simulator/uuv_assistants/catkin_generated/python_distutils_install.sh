...
echo_and_run cd "/root/userdir/src/uuv_simulator/uuv_assistants"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/userdir/src/uuv_simulator/uuv_assistants/setup.py" \
     \
    build --build-base "/root/userdir/build/uuv_simulator/uuv_assistants" \
    install \
    --root="${DESTDIR-/}" \
