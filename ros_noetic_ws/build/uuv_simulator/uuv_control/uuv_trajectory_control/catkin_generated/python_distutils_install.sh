...
echo_and_run cd "/root/userdir/src/uuv_simulator/uuv_control/uuv_trajectory_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/userdir/src/uuv_simulator/uuv_control/uuv_trajectory_control/setup.py" \
     \
    build --build-base "/root/userdir/build/uuv_simulator/uuv_control/uuv_trajectory_control" \
    install \
    --root="${DESTDIR-/}" \
