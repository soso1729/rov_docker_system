...
echo_and_run cd "/root/userdir/src/uuv_simulator/uuv_control/uuv_thruster_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/userdir/src/uuv_simulator/uuv_control/uuv_thruster_manager/setup.py" \
     \
    build --build-base "/root/userdir/build/uuv_simulator/uuv_control/uuv_thruster_manager" \
    install \
    --root="${DESTDIR-/}" \
