...
echo_and_run cd "/root/userdir/src/uuv_simulator/uuv_control/uuv_auv_control_allocator"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/userdir/src/uuv_simulator/uuv_control/uuv_auv_control_allocator/setup.py" \
     \
    build --build-base "/root/userdir/build/uuv_simulator/uuv_control/uuv_auv_control_allocator" \
    install \
    --root="${DESTDIR-/}" \
