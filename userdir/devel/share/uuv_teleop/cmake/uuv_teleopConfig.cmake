...
if("TRUE" STREQUAL "TRUE")
  set(uuv_teleop_SOURCE_PREFIX /root/userdir/src/uuv_simulator/uuv_teleop)
  set(uuv_teleop_DEVEL_PREFIX /root/userdir/devel)
  ...
  set(uuv_teleop_INSTALL_PREFIX /root/userdir/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uuv_teleop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/userdir/src/uuv_simulator/uuv_teleop/${idir}'.  ${_report}")
    endif()
